...
class FixedAgentBridge:
    ...
    def __init__(self, agent_name: str):
        ...
        logger.info(f"FixedAgentBridge initialized for {agent_name} ({self.session_name})")
...
class FixedBridgeManager:
    """Manages fixed agent bridges"""

    def __init__(self):
        self.bridges: Dict[str, FixedAgentBridge] = {}
        self.message_bus = get_message_bus()
    ...
    def start_all(self):
        ...
        for agent_name in AGENT_SESSIONS.keys():
            try:
                bridge = FixedAgentBridge(agent_name)
                bridge.start()
                self.bridges[agent_name] = bridge
                logger.info(f"Started fixed bridge for {agent_name}")
            except Exception as e:
    ...
    def get_bridge(self, agent_name: str) -> Optional[FixedAgentBridge]:
